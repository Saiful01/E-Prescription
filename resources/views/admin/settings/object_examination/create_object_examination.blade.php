...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col">
                <h3 class="page-title">Objective Examination Create</h3>
                <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/object/examination/save" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="col-form-label col-md-2">Objective Examination Name</label>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="objective_examination_title" required>
                            </div>
                        </div>
