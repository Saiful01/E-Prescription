            ...
            <div class="profile-header">
                <div class="row align-items-center">
                    <div class="col-auto profile-image">
                        <a href="#">
                            <img class="rounded-circle" alt="User Image" src="/images/user/{{Auth::user()->profile_pic}}" >
                        </a>
                    </div>
                    <div class="col ml-md-n2 profile-user-info">
                        <h4 class="user-name mb-0">{{Auth::user()->user_login}}</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="col-sm-10">"{{Auth::user()->full_name}}"</p>
                                    </div>
                                    <div class="row">
